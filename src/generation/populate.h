...
namespace populate_data {
    inline const MonsterDef MONSTERS[] = {
        ...
        {"ogre",            1,  0, 1, 40,  20,  6, 16,  8, 2,  70,  5,  55},
        {"golem",           1,  4, 1, 55,  16,  4, 22, 10, 5,  50,  0,  70},
        {"basilisk",        1,  6, 7, 30,  12, 10, 14,  5, 2,  90, 10,  55},
        {"yeti",            1,  2, 7, 42,  18, 10, 16,  8, 2,  85, 10,  65},
        {"centaur",         1,  5, 7, 28,  14, 16, 12,  5, 1, 130, 15,  45},
        {"imp",             1,  0,11, 12,   6, 18,  6,  3, 0, 140, 50,  20},
        {"gargoyle",        1,  3,11, 35,  14, 12, 18,  6, 4,  80,  0,  60},
